...
$ret=mysqli_query($con,"select count(id) as id4 from lecture_reg ");
 ...
 $ret=mysqli_query($con,"select count(course_id) as id5 from course ");
 $row=mysqli_fetch_array($ret); 

 $ret=mysqli_query($con,"select count(id) as id6 from t_time where g_approval='Approved' and approval='Approved'");
 $row3=mysqli_fetch_array($ret);  

 $ret=mysqli_query($con,"select count(id) as id7 from t_time where approval='Approved' and g_approval='Not Approved'");
...
<head>
  ...
  function moreinfo(x){
    if (x==1){
      ...
      document.getElementById('M1').style.border = 'none';
      document.getElementById('M2').style.border = 'none';
      document.getElementById('M3').style.border = 'block';
    }
  }
...
?>
  ...
  <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <button class="small-box-footer" style="width: 100%;" onclick="moreinfo(1)" id="M1">More info <i class="fas fa-arrow-circle-right"></i></button>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <button class="small-box-footer" style="width: 100%;" onclick="moreinfo(2)" id="M2">More info <i class="fas fa-arrow-circle-right"></i></button>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <button class="small-box-footer" style="width: 100%;" onclick="moreinfo(3)" id="M3">More info <i class="fas fa-arrow-circle-right"></i></button>
            </div>
          </div>
          <!-- ./col -->
        </div>
    ...
    <div class="container" style=" display:none; width: 80%; margin-right:0% " id="moreinfo1">
    ...
    <div class="container" style=" display: none; width: 80%; margin-right:0% " id="moreinfo2">
    ...
    <table class="table table-striped table-bordered"   width="96%"   cellspacing="0">
            ...
            <?php
              $ret=mysqli_query($con,"select * from t_time where g_approval='Approved'");
    ...
    <div class="container" style="display: none; width: 80%; margin-right:0% " id="moreinfo3">
            <table class="table table-striped table-bordered" id="dataTable" width="96%"   cellspacing="0">
            <thead>
                <tr>
            ...
            <?php
              $ret=mysqli_query($con,"select * from t_time where g_approval='Not Approved'");
