...
include 'connection.php';
    ...
    if($BidAcceptResultCheck > 0) {
        ...
        $query ="UPDATE t_time SET approval = '$accepted' Where id='$cid'";
        mysqli_query($con,$query);
        ...
        <table class="table table-striped table-bordered" id="dataTable" width="96%" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th>Total Hours</th>
                    <th>Approval</th>
                    <th>Genaral Manager Approval</th>
                    <th>Action</th>
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="approve.php?editid=<?php echo $row['id']; ?> Approved" class="btn btn-xs btn-primary">Approve<i class="feather icon-clock m-t-10 f-16 "></i></a>
                        </td>
                    </tr>
