 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Lecture Registration</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <fieldset>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="username" name="username" placeholder="" class="input-xlarge" maxlength="10" style="width: 400px; height:40%;" required>
    ...
    <div class="control-group">
      <!-- Button -->
      <div class="controls">
        <button class="btn btn-success" id="submit1" name="submit">Register</button>
      </div>
    </div>
  </fieldset>
</form>
